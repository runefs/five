use crate::analysis::{FunctionDescription, GenericsInfo, ModuleInfo, ParameterInfo, TypeDescription};
...
impl Compiled<ModuleInfo> for CompiledModule {
    fn emit(&self) -> proc_macro2::TokenStream {
                    ...
                    segments.push(syn::PathSegment {
                        ...
                        arguments: syn::PathArguments::AngleBracketed(
                            syn::AngleBracketedGenericArguments {
                                ...
                                args: context.base.generics.params.iter().map(|param| {
                                    match param {
        ...
        let params: Vec<ParameterInfo> = field_names.iter().zip(field_types.iter())
